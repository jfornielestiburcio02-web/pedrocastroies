        ...
        <tbody>
              ...
              <table width="100%">
                <tbody>
                  <tr>
                    <td>
                      <img
                        src="/images/puertaTrasera/logo_rayuela.gif"
                        width="230"
                        height="157"
                        alt=""
                      />
          ...
          <tr>
            ...
            <td className="moradoclaro" align="right">
              <img
                src="/images/puertaTrasera/txt_ray.gif"
                width="167"
                height="36"
                alt=""
              />
            ...
            <td className="lila" align="left">
              <img
                src="/images/puertaTrasera/txt_uela.gif"
                width="166"
                height="36"
                alt=""
              />
          ...
          <tr>
            ...
            <td className="verdeagua" align="right">
              <img
                src="/images/puertaTrasera/tit_plataforma.gif"
                width="167"
                height="32"
                alt=""
              />
            ...
            <td className="verde" align="right">
              <img
                src="/images/puertaTrasera/tit_educativa.gif"
                width="166"
                height="32"
                alt=""
              />
          ...
          <tr>
            ...
            <td align="right">
              <img
                src="/images/puertaTrasera/tit_extrem.gif"
                width="166"
                height="17"
                alt=""
              />
          ...
          <tr>
            ...
            <td align="center">
              <img
                src="/images/puertaTrasera/logo_junta.gif"
                width="166"
                height="59"
                alt=""
              />
              <br />
              <img
                src="/images/puertaTrasera/FEDER-UE.jpg"
                width="165"
                height="44"
                alt=""
              />
